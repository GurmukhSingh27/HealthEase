...
io.on("connection", (socket) => {
  socket.on("joinRoom", ({ username, room }) => {
    ...
    io.to(user.room).emit("roomUsers", {                      // send users and room info
      room: user.room,
  ...
  socket.on("chatMessage", (msg) => {                       // listen for chatMessage
  ...
  socket.on("disconnect", () => {                          // runs when clients disconnects
